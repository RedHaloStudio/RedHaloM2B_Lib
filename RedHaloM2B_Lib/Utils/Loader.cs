...
namespace RedHaloM2B
{
    ...
    public class MenuUtilities
    {
        ...
        static string menuName = "RedHalo Menu";
        private static void MenuPostLoadHandler(IntPtr objPtr, INotifyInfo infoPtr)
        {
            IIMenu menu = RedHaloCore.Core.MenuManager.FindMenu(menuName);
            if (menu == null)
                InstallMenu();
        }
        ...
        private static uint InstallMenu()
        {
            try
            {
                ...
                menuManager.RegisterMenuBarContext(0x58527952, menuName);
                IIMenu mainMenuBar = menuManager.MainMenuBar;
                IIMenu redHaloMainMenu = RedHaloCore.Global.IMenu;
                redHaloMainMenu.Title = menuName;
                menuManager.RegisterMenu(redHaloMainMenu, 0);
                ...
                redHaloMenu.SubMenu = redHaloMainMenu;
                menuManager.MainMenuBar.AddItem(redHaloMenu, -1);
